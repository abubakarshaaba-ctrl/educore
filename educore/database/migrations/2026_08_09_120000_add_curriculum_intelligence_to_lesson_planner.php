...
return new class extends Migration {
    ...
    {
        // Production-safe/idempotent migration. Some hosts may have applied part
        // of the original migration before an interrupted deployment. Never let
        // an already-created column/table prevent the migration chain from
        // completing and reaching the later repair migrations.
        ...
        if (! Schema::hasTable('curriculum_fragments')) {
