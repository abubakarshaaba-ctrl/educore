...
return new class extends Migration
{
    ...
    {
        Schema::create('migration_financial_records', function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamps();
            $table->unique(['migration_id', 'entity_type', 'source_key'], 'migration_financial_source_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('migration_financial_records');
    }
};
