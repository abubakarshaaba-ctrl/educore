...
return new class extends Migration
{
    ...
    {
        // This follow-up migration repairs deployments where the original
        // knowledge-base migration was recorded but one or both tables are
        // absent (for example after an interrupted deployment).
    ...
    {
        // Repair migrations must not drop live knowledge-base data on rollback.
    }
};
