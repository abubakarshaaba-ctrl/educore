...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(AuthenticateApiToken::class)->group(function () {
        ...
        Route::post('reports/compute', [ReportsController::class, 'compute']);
        Route::post('reports/publish', [ReportsController::class, 'publish']);
        Route::post('reports/unpublish', [ReportsController::class, 'unpublish']);
        Route::get('reports/{summary}/pdf', [ReportsController::class, 'pdf']);
        ...
        Route::middleware('super.admin')->prefix('platform')->group(function () {
            ...
            Route::post('broadcasts/{broadcast}/expire', [PlatformBroadcastController::class, 'expire']);
        });
        ...
        Route::prefix('transport-officer')->group(function () {
            ...
            Route::delete('assignments/{student}', [TransportOfficerController::class, 'unassign']);
        });
