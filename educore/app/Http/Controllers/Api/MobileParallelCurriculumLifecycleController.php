...
class MobileParallelCurriculumLifecycleController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        if ($armTeachingModesReady) {
            $classRelations[] = 'arms.classTeacher';
        }
        ...
        return response()->json([
                    ...
                    'arms' => $class->arms->map(fn (ParallelCurriculumClassArm $arm) => [
                        ...
                        'teaching_assignment_mode' =>
                            $armTeachingModesReady
                                ? (string) (
                                    $arm->teaching_assignment_mode
                                    ?: 'subject_based'
                                )
                                : 'subject_based',
                        'class_teacher_id' =>
                            $armTeachingModesReady && $arm->class_teacher_id
            ...
            'arm_teaching_modes_ready' => $armTeachingModesReady,
    ...
    public function storeArmTeachingMode(Request $request): JsonResponse
    {
        $tenantId = $this->assertManage($request);
