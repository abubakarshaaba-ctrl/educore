...
{
    use Queueable;
    public function __construct(public readonly Tenant $tenant, public readonly ?string $trialEndsAt = null) {}
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        if ($this->trialEndsAt) $mail->line('Trial access is available until '.$this->trialEndsAt.'.');
        $mail->line('Next: add your school settings, academic session, classes, subjects and staff.')
