...
<style>
    ...
    .ec-stat-grid { display:grid;grid-template-columns:repeat(3,minmax(0,1fr));margin-bottom:20px; }
    ...
    .level-section { font-size:11px;font-weight:700;color:var(--brand-gold-dark);text-transform:uppercase;letter-spacing:0.05em;margin-top:3px; }
    ...
    @media(max-width:640px) { .ec-stat-grid { grid-template-columns:1fr; } }
</style>
@endpush
...
<div class="ec-stat-grid">
    <div class="ec-stat-card">
        <div class="ec-stat-value">{{ $totalLevels ?? $levels->count() }}</div>
        <div class="ec-stat-label">Class Levels</div>
    </div>
    <div class="ec-stat-card">
        <div class="ec-stat-value">{{ $totalArms ?? '—' }}</div>
        <div class="ec-stat-label">Class Arms</div>
    </div>
    <div class="ec-stat-card">
        <div class="ec-stat-value">{{ $totalStudents ?? '—' }}</div>
