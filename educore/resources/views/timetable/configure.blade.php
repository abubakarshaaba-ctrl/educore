...
.day-hours{margin:4px 0 16px;border:1px solid var(--border);border-radius:10px;overflow:hidden}.day-hours-head{padding:10px 12px;background:#F8FAFC;border-bottom:1px solid var(--border)}.day-hours-title{font-size:12px;font-weight:700;color:var(--midnight)}.day-hours-note{font-size:11px;color:var(--slate);margin-top:2px;line-height:1.45}.day-hours-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:0}.day-hour{padding:10px;border-right:1px solid var(--border);min-width:0}.day-hour:last-child{border-right:none}.day-name{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.04em;color:var(--slate);margin-bottom:5px}.day-hour .form-control{min-width:0}.day-summary{font-size:11px;color:var(--slate);margin-top:4px;overflow-wrap:anywhere}.preview-day{display:flex;justify-content:space-between;gap:8px;padding:8px 0;border-bottom:1px solid var(--border);font-size:12px}.preview-day:last-child{border-bottom:none}.preview-day strong{color:var(--midnight)}.preview-day span{text-align:right;overflow-wrap:anywhere}
