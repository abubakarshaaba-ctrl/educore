...
.card{background:white;border-radius:20px;padding:40px 32px;text-align:center;max-width:520px;width:100%;box-shadow:0 4px 24px rgba(0,0,0,0.08);border:1px solid #E2E8F0;min-width:0}
...
h1{font-size:24px;font-weight:800;color:#059669;margin-bottom:8px;overflow-wrap:anywhere}
p{font-size:15px;color:#64748B;margin-bottom:20px;line-height:1.6;overflow-wrap:anywhere}
.app-number{background:#F0FDF4;border:2px dashed #86EFAC;border-radius:12px;padding:16px 20px;margin:20px 0;min-width:0}
...
.app-number .num{font-size:22px;font-weight:800;font-family:monospace;color:#065F46;letter-spacing:.05em;overflow-wrap:anywhere;word-break:break-all}
.info{background:#EFF6FF;border-radius:10px;padding:14px 16px;font-size:13px;color:#1E40AF;margin-bottom:20px;text-align:left;line-height:1.6;overflow-wrap:anywhere}
...
.sms-note{font-size:12px;color:#94A3B8;margin-top:16px;overflow-wrap:anywhere}
@media(max-width:560px){
    body{padding:12px}
    .card{padding:28px 18px;border-radius:16px}
    .check{width:66px;height:66px;font-size:30px;margin-bottom:16px}
    h1{font-size:21px}
    p{font-size:14px}
    .app-number{padding:14px 12px}
    .app-number .num{font-size:18px;letter-spacing:.02em}
    .btn{width:100%;margin:4px 0;min-height:44px}
}
@media(max-width:380px){.card{padding:24px 14px}.info{padding:12px}}
</style>
</head>
<body>
<div class="card">
