...
body{font-family:DejaVu Sans,Arial,sans-serif;font-size:10px;line-height:1.32;color:#1e293b;background:#fff}
.header{display:table;width:100%;padding-bottom:8px;border-bottom:2px solid #071E45;margin-bottom:9px}
.school-info,.payslip-label{display:table-cell;vertical-align:top;width:50%}
.school-info h1{font-size:15px;font-weight:700;color:#071E45;margin-top:2px}
.school-info p{font-size:8.5px;color:#64748B;margin-top:1px}
.payslip-label{text-align:right}
.payslip-label .title{font-size:17px;font-weight:800;color:#071E45;letter-spacing:.04em}
.payslip-label .sub{font-size:9px;color:#64748B;margin-top:2px}
.gold-rule{height:3px;background:#D79A21;margin-top:4px}
.section{border:1px solid #E2E8F0;border-radius:5px;padding:7px 9px;margin-bottom:7px;page-break-inside:avoid}
.section-title{font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:#071E45;margin-bottom:5px}
.info-grid{display:table;width:100%}.info-row{display:table-row}.info-item{display:table-cell;width:33.33%;padding:2px 8px 3px 0;vertical-align:top}
.info-item label{font-size:7.5px;font-weight:700;color:#94A3B8;display:block;margin-bottom:1px;text-transform:uppercase}
.info-item span{font-size:9.5px;font-weight:600;color:#0F172A}
table{width:100%;border-collapse:collapse}th{padding:4px 6px;background:#F8FAFC;font-size:7.5px;font-weight:700;text-transform:uppercase;color:#64748B;text-align:left;border-bottom:1px solid #E2E8F0}td{padding:4px 6px;border-bottom:1px solid #F1F5F9;font-size:9.5px}td:last-child{text-align:right;font-weight:600}.total-row td{background:#FEF9EC;font-weight:700;color:#071E45;border-top:1px solid #D79A21}.net-box{background:#071E45;color:#fff;border-radius:5px;padding:8px 11px;display:table;width:100%;margin-top:7px;page-break-inside:avoid}.net-label,.net-amount{display:table-cell;vertical-align:middle}.net-label{font-size:8.5px;font-weight:700;letter-spacing:.05em}.net-amount{text-align:right;font-size:17px;font-weight:800;color:#F1B947}.footer{margin-top:8px;padding-top:6px;border-top:1px solid #E2E8F0;font-size:7.5px;color:#94A3B8;text-align:center}.status-badge{display:inline-block;padding:2px 7px;border-radius:10px;font-size:7.5px;font-weight:700}.paid{background:#ECFDF5;color:#047857}.pending{background:#FEF9EC;color:#B8810D}
</style>
</head>
<body>
<div class="header">
    <div class="school-info">
        ...
        @if(file_exists($psLogoPath))<img src="{{ $psLogoPath }}" alt="Logo" style="height:32px;margin-bottom:3px">@endif
        @endif
