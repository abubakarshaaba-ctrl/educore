...
.agent-copy h1{font-size:clamp(2.6rem,5vw,4.5rem);line-height:1.02;letter-spacing:-.045em;margin:16px 0 14px;max-width:700px;color:#fff;text-shadow:0 3px 20px rgba(0,0,0,.18)}.agent-copy h1 span{color:#f4bd42}.agent-copy>p{font-size:1.05rem;line-height:1.55;color:#e0e9f5;max-width:640px}
.agent-feature-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:26px;max-width:640px}.agent-feature{display:flex;gap:13px;padding:15px;border:1px solid rgba(42,154,238,.72);border-radius:12px;background:rgba(2,33,69,.70);backdrop-filter:blur(7px);box-shadow:inset 0 1px rgba(255,255,255,.04)}.agent-feature svg{width:28px;height:28px;color:#f4bd42;flex:none}.agent-feature b{display:block;font-size:.88rem}.agent-feature small{display:block;margin-top:4px;color:#c6d4e5;font-size:.75rem;line-height:1.4}
