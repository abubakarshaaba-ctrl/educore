...
.ac-status-value{font-size:18px;font-weight:800;line-height:1.2;overflow-wrap:anywhere}
.ac-status-sub{font-size:11px;opacity:.65;margin-top:3px;overflow-wrap:anywhere}
.ac-status-none{font-size:14px;font-weight:600;color:#F87171}
.ac-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:20px;margin-bottom:20px}
.ac-grid>div{min-width:0}
.ac-card{background:white;border:1px solid var(--border);border-radius:12px;overflow:hidden;margin-bottom:16px;min-width:0}
.ac-card-head{padding:13px 18px;border-bottom:1px solid var(--border);background:#F8FAFC;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap}
...
.ac-form input,.ac-form select{width:100%;min-width:0;padding:9px 12px;border:1px solid var(--border);border-radius:8px;font-size:13px;font-family:inherit;outline:none;background:#F8FAFC;transition:border 150ms}
.ac-form input:focus,.ac-form select:focus{border-color:var(--indigo);background:white}
.ac-form .fg-row{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:10px}
.ac-check{display:flex;align-items:center;gap:8px;font-size:12px;font-weight:600;color:var(--midnight);margin-bottom:12px;cursor:pointer;text-transform:none!important;letter-spacing:normal!important}
.ac-check input{width:16px!important;height:16px;min-width:16px!important;accent-color:var(--indigo);cursor:pointer}
.btn-ac-save{width:100%;min-height:42px;padding:10px;background:var(--indigo);color:white;border:none;border-radius:8px;font-size:13px;font-weight:700;cursor:pointer;font-family:inherit}
.btn-ac-save:hover{background:#1D4ED8}
.ac-table-wrap{width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch}
.ac-table{width:100%;border-collapse:collapse;min-width:640px}
...
.badge-inactive{background:#FFF7ED;color:#D97706;border-radius:20px;padding:2px 9px;font-size:10px;font-weight:700;white-space:nowrap}
.ac-actions{display:flex;gap:5px;flex-wrap:wrap;align-items:center}
.btn-sm-act{padding:4px 10px;border-radius:6px;font-size:11px;font-weight:700;border:none;cursor:pointer;font-family:inherit;display:inline-flex;align-items:center;justify-content:center;gap:3px;min-height:30px}
...
.alert-s{background:#ECFDF5;border:1px solid #A7F3D0;border-radius:8px;padding:12px 16px;font-size:13px;color:#065F46;margin-bottom:16px;overflow-wrap:anywhere}
.alert-e{background:#FEF2F2;border:1px solid #FCA5A5;border-radius:8px;padding:12px 16px;font-size:13px;color:#991B1B;margin-bottom:16px;overflow-wrap:anywhere}
.ac-bottom{display:flex;gap:10px;flex-wrap:wrap}
.btn-ac-link{display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:9px 16px;border:1px solid var(--border);border-radius:8px;background:white;color:var(--midnight);font-size:12px;font-weight:600;text-decoration:none;min-height:40px}
...
@media(max-width:640px){
    .ac-banner{grid-template-columns:1fr;padding:16px;border-radius:10px}
    .ac-card-head,.ac-card-body{padding-left:14px;padding-right:14px}
    .ac-form .fg-row{grid-template-columns:1fr}
    .ac-table{min-width:600px}
    .edit-inline-form{align-items:stretch}
    .edit-inline-form input{width:100%;min-width:0!important}
    .ac-bottom{flex-direction:column}
    .btn-ac-link{width:100%}
}
@media(max-width:420px){
    .ac-banner{padding:14px}
    .ac-card{border-radius:9px}
    .ac-card-head,.ac-card-body{padding-left:12px;padding-right:12px}
}
</style>
@endpush
@section('content')
