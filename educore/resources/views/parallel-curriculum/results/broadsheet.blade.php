...
@push('styles')
<style>
.pcb{max-width:1420px;margin:0 auto}.hero{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;flex-wrap:wrap;padding:16px 18px;margin-bottom:14px;border-radius:13px;background:linear-gradient(135deg,#071E45,#0B2D63);color:#D79A21}.hero h2{margin:0 0 5px;font-size:18px;color:#D79A21!important}.hero p{margin:0;color:#F4D88A!important;font-size:11.5px;line-height:1.55}.panel{background:#fff;border:1px solid var(--border);border-radius:12px;overflow:hidden;margin-bottom:14px}.head{display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;padding:11px 14px;background:#F8FAFC;border-bottom:1px solid var(--border);font-size:12px;font-weight:800;color:var(--midnight)}.body{padding:14px}.filters{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:9px;align-items:end}.fg{display:flex;flex-direction:column;gap:5px}.fl{font-size:10px;font-weight:800;color:var(--slate)}.fc{width:100%;min-height:39px;border:1px solid var(--border);border-radius:8px;padding:8px 10px;background:#fff;font:500 11.5px inherit}.btn{display:inline-flex;align-items:center;justify-content:center;min-height:39px;padding:8px 13px;border-radius:8px;border:0;font:800 11px inherit;text-decoration:none;cursor:pointer}.btn-p{background:var(--indigo);color:#fff}.btn-s{background:#fff;color:var(--midnight);border:1px solid var(--border)}.actions{display:flex;gap:7px;flex-wrap:wrap}.context{display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;padding:12px 14px;background:#FBFCFE;border:1px solid var(--border);border-radius:10px;margin-bottom:12px}.context h3{margin:0;color:var(--midnight);font-size:14px}.context p{margin:3px 0 0;color:var(--slate-light);font-size:10.5px}.chips{display:flex;gap:6px;flex-wrap:wrap}.chip{padding:4px 8px;border-radius:999px;background:#F2F4F7;color:#475467;font-size:9.5px;font-weight:800}.sheet{overflow:auto;border:1px solid var(--border);border-radius:10px;max-height:70vh}.sheet table{width:100%;min-width:920px;border-collapse:collapse;white-space:nowrap}.sheet th{position:sticky;top:0;z-index:3;padding:8px 7px;background:var(--midnight);color:#D79A21!important;border-right:1px solid rgba(255,255,255,.12);font-size:9px;text-align:center}.sheet th.student{left:0;z-index:5;text-align:left;min-width:190px}.sheet td{padding:8px 7px;border-right:1px solid #EEF2F7;border-bottom:1px solid #EEF2F7;text-align:center;font-size:10.5px;color:var(--slate)}.sheet td.student{position:sticky;left:0;z-index:2;background:#fff;text-align:left;min-width:190px}.sheet tbody tr:nth-child(even) td{background:#FAFBFC}.sheet tbody tr:nth-child(even) td.student{background:#FAFBFC}.student-name{font-weight:800;color:var(--midnight)}.student-adm{margin-top:2px;font-size:9px;color:var(--slate-light)}.score{font-weight:800;color:var(--midnight)}.missing{color:#CBD5E1}.summary{font-weight:800;background:#F8FAFC!important}.pos{color:#B7791F}.stats td{background:#EFF6FF!important;font-size:9px;line-height:1.45}.empty{padding:30px;text-align:center;color:var(--slate-light);font-size:11.5px}.print-head{display:none}
...
@media print{
 ...
 #parallel-broadsheet-print .sheet th{position:static;background:#071E45!important;color:#D79A21!important;font-size:7px;padding:4px}
