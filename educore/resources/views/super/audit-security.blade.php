...
@endphp
<style>
.asc-head{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:18px}.asc-head h1{font-size:22px;margin-bottom:5px}.asc-head p{font-size:12.5px;color:var(--slate);line-height:1.5}
.asc-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-bottom:18px}.asc-card{background:#fff;border:1px solid var(--border);border-radius:12px;padding:14px;min-width:0}.asc-label{font-size:10px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;color:var(--slate-light)}.asc-value{font-size:24px;font-weight:800;margin-top:6px}.asc-note{font-size:11px;color:var(--slate);margin-top:3px;line-height:1.4}
.panel{background:#fff;border:1px solid var(--border);border-radius:12px;margin-bottom:16px;overflow:hidden;min-width:0}.panel-head{padding:14px 16px;border-bottom:1px solid var(--border);display:flex;align-items:center;justify-content:space-between;gap:10px}.panel-head h2{font-size:14px}.panel-body{padding:14px 16px}.filter-grid{display:grid;grid-template-columns:1.1fr 1.1fr .8fr auto;gap:10px;align-items:end}.field{min-width:0}.field label{display:block;font-size:10px;font-weight:700;color:var(--slate);margin-bottom:5px}.field input,.field select{width:100%;min-width:0;border:1px solid var(--border);border-radius:8px;padding:8px 10px;font:inherit;font-size:12px;background:#fff}
.status{display:inline-flex;align-items:center;padding:3px 8px;border-radius:999px;font-size:10px;font-weight:700}.status.ok{background:#ECFDF5;color:#047857}.status.warn{background:#FFFBEB;color:#B45309}.status.info{background:#EFF6FF;color:#1D4ED8}.status.muted{background:#F1F5F9;color:#64748B}.action{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10.5px;overflow-wrap:anywhere}.small{font-size:11px;color:var(--slate)}.empty{padding:24px;text-align:center;color:var(--slate);font-size:12px}.two-col{display:grid;grid-template-columns:1fr 1fr;gap:16px}.kv{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;padding:9px 0;border-bottom:1px solid #F1F5F9;font-size:12px}.kv:last-child{border-bottom:0}.token-device{max-width:220px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.asc-table{width:100%;border-collapse:collapse}.asc-table th{font-size:9.5px;text-transform:uppercase;letter-spacing:.05em;color:var(--slate-light);text-align:left;padding:9px 10px;border-bottom:1px solid var(--border);white-space:nowrap}.asc-table td{font-size:11.5px;padding:10px;border-bottom:1px solid #F1F5F9;vertical-align:top}.asc-table tr:last-child td{border-bottom:0}.pager{padding:12px 16px}.signal-copy{font-size:10.5px;color:var(--slate);margin-top:3px;overflow-wrap:anywhere}.responsive-table{width:100%;max-width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch}
...
@media(max-width:640px){
    .asc-head{flex-direction:column;gap:10px;margin-bottom:14px}.asc-head h1{font-size:20px}.asc-head p{font-size:12px}.asc-head .btn{width:auto;min-height:38px}
    .asc-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px;margin-bottom:14px}.asc-card{padding:11px 10px!important;min-height:108px}.asc-label{font-size:8.5px;letter-spacing:.04em;line-height:1.25}.asc-value{font-size:21px;margin-top:5px}.asc-note{font-size:9.5px;line-height:1.3}
    .filter-grid{grid-template-columns:1fr!important}.filter-grid .btn{width:100%;justify-content:center}.panel-head{align-items:flex-start;flex-direction:column;padding:11px 12px}.panel-body{padding:12px}.asc-table{min-width:700px}.token-device{max-width:160px}.two-col{gap:12px}.kv{font-size:11.5px;align-items:start}.kv strong,.kv .status{text-align:right}.pager{padding:10px 12px}
}
@media(max-width:380px){.asc-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}.asc-card{padding:9px 8px!important;min-height:104px}.asc-value{font-size:19px}.asc-note{font-size:9px}}
</style>
