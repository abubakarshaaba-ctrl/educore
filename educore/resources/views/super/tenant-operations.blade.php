...
@section('content')
<style>
.ops-head{display:flex;justify-content:space-between;align-items:flex-start;gap:16px;margin-bottom:18px}.ops-head h1{font-size:22px;margin-bottom:5px}.ops-head p{font-size:12.5px;color:var(--slate);max-width:760px}.ops-actions{display:flex;gap:8px;flex-wrap:wrap}
.ops-stats{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:12px;margin-bottom:18px}.stat{background:#fff;border:1px solid var(--border);border-radius:12px;padding:14px;min-width:0}.stat small{font-size:9.5px;font-weight:800;text-transform:uppercase;letter-spacing:.06em;color:var(--slate-light)}.stat strong{display:block;font-size:22px;margin-top:6px}.stat span{display:block;font-size:10.5px;color:var(--slate);margin-top:2px;line-height:1.35}
.panel{background:#fff;border:1px solid var(--border);border-radius:12px;overflow:hidden;margin-bottom:16px;min-width:0}.panel-head{padding:14px 16px;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:center;gap:10px}.panel-head h2{font-size:14px}.panel-body{padding:14px 16px}.filters{display:grid;grid-template-columns:1.4fr .8fr auto auto;gap:10px;align-items:end}.field label{display:block;font-size:10px;font-weight:700;color:var(--slate);margin-bottom:5px}.field input,.field select{width:100%;min-width:0;border:1px solid var(--border);border-radius:8px;padding:8px 10px;font:inherit;font-size:12px;background:#fff}.check{display:flex;gap:7px;align-items:center;font-size:11px;min-height:36px}.check input{width:auto}
.responsive-table{width:100%;max-width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch}.ops-table{width:100%;border-collapse:collapse;min-width:1050px}.ops-table th{font-size:9.5px;text-transform:uppercase;letter-spacing:.05em;color:var(--slate-light);text-align:left;padding:9px 10px;border-bottom:1px solid var(--border);white-space:nowrap}.ops-table td{padding:10px;font-size:11.5px;border-bottom:1px solid #F1F5F9;vertical-align:top}.ops-table tr:last-child td{border-bottom:0}.school{font-weight:800;font-size:12px}.slug{font-size:10px;color:var(--slate);margin-top:2px}.badge2{display:inline-flex;padding:3px 7px;border-radius:999px;font-size:9.5px;font-weight:800;text-transform:capitalize}.active{background:#ECFDF5;color:#047857}.pending{background:#FFFBEB;color:#B45309}.suspended,.subscription_expired{background:#FEF2F2;color:#B91C1C}.unknown{background:#F1F5F9;color:#64748B}.metric{font-weight:700}.subtle{font-size:10px;color:var(--slate);margin-top:2px}.attention{display:flex;flex-wrap:wrap;gap:4px;max-width:260px}.flag{display:inline-flex;padding:2px 6px;border-radius:999px;background:#FFF7ED;color:#C2410C;font-size:9px;font-weight:700}.okflag{display:inline-flex;padding:2px 6px;border-radius:999px;background:#ECFDF5;color:#047857;font-size:9px;font-weight:700}.pager{padding:12px 16px;overflow-x:auto}.empty{padding:24px;text-align:center;color:var(--slate);font-size:12px}
@media(max-width:1200px){.ops-stats{grid-template-columns:repeat(3,minmax(0,1fr))}}
@media(max-width:800px){.ops-head{flex-direction:column}.ops-actions{width:100%}.ops-actions .btn{flex:1;justify-content:center}.filters{grid-template-columns:1fr 1fr}.ops-stats{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media(max-width:640px){.ops-head{gap:12px;margin-bottom:14px}.ops-head h1{font-size:20px;line-height:1.2}.ops-head p{font-size:11.5px;line-height:1.5}.ops-actions{gap:6px}.ops-actions .btn{padding:8px 10px;font-size:11px;white-space:nowrap}.ops-stats{gap:8px;margin-bottom:14px}.stat{padding:10px 11px;border-radius:10px}.stat small{font-size:8.5px;line-height:1.25}.stat strong{font-size:19px;margin-top:4px}.stat span{font-size:9px}.filters{grid-template-columns:1fr}.panel-head{flex-direction:column;align-items:flex-start;padding:11px 12px}.panel-body{padding:12px}.panel{border-radius:10px}.field input,.field select{min-height:40px}.filters .btn{width:100%;justify-content:center}.ops-table{min-width:940px}.ops-table th{font-size:8.8px;padding:8px}.ops-table td{font-size:10.5px;padding:8px}.pager{padding:10px 12px}}
@media(max-width:360px){.stat{padding:9px}.stat small{font-size:8px}.stat strong{font-size:18px}.stat span{font-size:8.5px}.ops-actions{display:grid;grid-template-columns:1fr}.ops-actions .btn{width:100%}}
</style>
...
<div class="ops-head">
    ...
    <div class="ops-actions"><a class="btn btn-ghost" href="{{ route('super.audit-security') }}">Audit & Security</a><a class="btn btn-ghost" href="{{ route('super.system-health') }}">System Health</a></div>
</div>
