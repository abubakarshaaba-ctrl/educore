...
@push('styles')
<style>
.health-header{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:20px}.health-header h1{font-size:22px;margin-bottom:5px}.health-header p{font-size:13px;color:var(--slate)}
.health-actions{display:flex;gap:8px;flex-wrap:wrap}.health-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin-bottom:18px}.health-card,.runtime-card,.check-card{background:#fff;border:1px solid var(--border);border-radius:12px;box-shadow:0 1px 2px rgba(15,23,42,.04)}.health-card{padding:16px}.health-card strong{display:block;font-size:24px;margin-top:7px}.health-card span{font-size:11px;text-transform:uppercase;letter-spacing:.06em;color:var(--slate)}
.health-grid{display:grid;grid-template-columns:minmax(0,1.7fr) minmax(280px,.8fr);gap:18px}.checks{display:grid;gap:10px}.check-card{padding:15px;display:flex;align-items:flex-start;gap:12px}.status-dot{width:10px;height:10px;border-radius:999px;margin-top:5px;flex:0 0 auto}.status-healthy{background:#059669}.status-warning{background:#D97706}.status-critical{background:#DC2626}.check-main{min-width:0;flex:1}.check-name{display:flex;align-items:center;justify-content:space-between;gap:10px;font-size:13px;font-weight:750}.check-detail{font-size:12px;color:var(--slate);line-height:1.55;margin-top:5px}.check-meta{font-size:11px;color:var(--slate-light);margin-top:6px;word-break:break-word}.status-label{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.04em}.label-healthy{color:#059669}.label-warning{color:#D97706}.label-critical{color:#DC2626}
.runtime-card{padding:17px}.runtime-card h2{font-size:14px;margin-bottom:13px}.runtime-list{display:grid;gap:0}.runtime-row{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:9px 0;border-bottom:1px solid #EEF2F7;font-size:12px}.runtime-row:last-child{border-bottom:0}.runtime-row span{color:var(--slate)}.runtime-row strong{text-align:right;word-break:break-word}.health-note{margin-top:14px;padding:12px;border-radius:9px;background:#F8FAFC;border:1px solid var(--border);font-size:11.5px;color:var(--slate);line-height:1.55}
@media(max-width:900px){.health-grid{grid-template-columns:1fr}}@media(max-width:640px){.health-header{flex-direction:column}.health-actions{width:100%}.health-actions .btn{flex:1}.health-summary{grid-template-columns:1fr}.check-name{align-items:flex-start}.runtime-row{align-items:flex-start}.runtime-row strong{max-width:58%}}
</style>
@endpush
