...
@section('page-title', 'Readmit Student')
...
<div class="card">
    <div class="ch">🎓 Readmit {{ $student->full_name }}</div>
    <div class="cb">
        ...
        <form method="POST" action="{{ route('students.readmit', $student) }}" enctype="multipart/form-data">
            @csrf
            <div class="fg">
            ...
            <div class="fg">
                <label class="fl">Readmission Class Arm</label>
            ...
            <div class="fg">
                <label class="fl">Reason / Readmission Note</label>
            ...
            <button type="submit" class="btn btn-p">🎓 Readmit Student</button>
