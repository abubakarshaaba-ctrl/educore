...
@push('styles')
<style>
.at-page{display:flex;flex-direction:column;gap:16px}.at-head{display:flex;justify-content:space-between;gap:14px;align-items:flex-start;flex-wrap:wrap}.at-head h2{margin:0;font-size:18px!important;color:var(--midnight)}.at-head p{margin:4px 0 0;color:var(--slate-light);font-size:12px;max-width:780px}.at-btn{min-height:40px;display:inline-flex;align-items:center;justify-content:center;gap:6px;border:1px solid var(--border);border-radius:8px;padding:0 14px;background:white;color:var(--midnight);font:inherit;font-size:12px;font-weight:800;text-decoration:none;cursor:pointer}.at-btn:hover:not(:disabled){box-shadow:0 1px 3px rgba(7,30,69,.12)}.at-btn-primary{background:var(--brand-gold);border-color:var(--brand-gold);color:var(--brand-navy)}.at-btn-danger{background:#FEF2F2;border-color:#FECACA;color:#991B1B}.at-btn:disabled{opacity:.46;cursor:not-allowed;box-shadow:none}.at-card{background:white;border:1px solid var(--border);border-radius:12px;overflow:hidden}.at-section-head{background:var(--brand-navy);color:white;padding:12px 16px;border-bottom:2px solid var(--brand-gold);display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap}.at-section-head strong{font-size:13px}.at-section-head small{display:block;color:#CBD5E1;font-size:11px;margin-top:2px}.at-body{padding:16px}.at-filter{display:grid;grid-template-columns:2fr 1fr 1fr auto;gap:10px;align-items:end;padding:14px 16px}.at-field label{display:block;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.04em;color:var(--slate-light);margin-bottom:5px}.at-field input,.at-field select,.at-field textarea{width:100%;box-sizing:border-box;border:1px solid var(--border);border-radius:8px;background:#F8FAFC;font:inherit;font-size:12px}.at-field input,.at-field select{height:40px;padding:0 10px}.at-field textarea{min-height:84px;padding:9px 10px}.at-field small{display:block;margin-top:4px;font-size:10px;line-height:1.4;color:var(--slate-light)}.at-table-wrap{overflow-x:auto}.at-table{width:100%;border-collapse:collapse;min-width:820px}.at-table th{height:38px;background:#F8FAFC;color:var(--slate-light);font-size:10px;text-transform:uppercase;letter-spacing:.04em;padding:8px 12px;text-align:left;border-bottom:1px solid var(--border);vertical-align:middle}.at-table td{height:44px;padding:9px 12px;border-bottom:1px solid var(--border);font-size:12px;vertical-align:middle}.at-table tr.selected{background:var(--brand-gold-light)}.at-name{font-weight:800;color:var(--midnight)}.at-sub{font-size:11px;color:var(--slate-light);margin-top:2px;line-height:1.45}.at-badge{display:inline-flex;align-items:center;border-radius:999px;padding:3px 8px;font-size:10px;font-weight:900}.at-active{background:#ECFDF5;color:#047857}.at-draft{background:#F1F5F9;color:#64748B}.at-locked{background:#FEF2F2;color:#991B1B}.at-editable{background:#EFF6FF;color:#1D4ED8}.at-total{display:flex;justify-content:space-between;align-items:center;padding-top:12px;margin-top:12px;border-top:1px solid var(--border);font-weight:900}.at-weight{display:inline-flex;border-radius:999px;background:var(--brand-gold-light);color:var(--brand-gold-dark);padding:5px 9px;font-size:11px;font-weight:900}.at-component{border:1px solid var(--border);border-radius:10px;padding:14px;margin-bottom:12px}.at-component.exam{border-left:3px solid var(--brand-gold)}.at-component-top{display:flex;justify-content:space-between;gap:10px;align-items:flex-start}.at-component-grid{display:grid;grid-template-columns:1.35fr .65fr 1fr 1.45fr .8fr .8fr auto;gap:10px;align-items:end;margin-top:12px}.at-component-grid .at-field{min-width:0}.at-builder{border:1px dashed #CBD5E1;border-radius:10px;padding:16px;margin-top:16px;background:#FCFDFE}.at-builder-grid{display:grid;grid-template-columns:1.4fr .65fr 1fr 1.45fr .8fr .8fr;gap:10px}.at-alert{border-radius:9px;padding:10px 13px;font-size:12px;line-height:1.5}.at-alert-success{background:#ECFDF5;border:1px solid #A7F3D0;color:#065F46}.at-alert-error{background:#FEF2F2;border:1px solid #FECACA;color:#991B1B}.at-alert-warn{background:#FFFBEB;border:1px solid #FDE68A;color:#92400E}.at-alert-info{background:#EFF6FF;border:1px solid #BFDBFE;color:#1E3A8A}.at-flow{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-top:12px}.at-flow-step{border:1px solid #D7E1EF;border-radius:9px;padding:12px;background:white}.at-flow-step strong{display:block;color:var(--brand-navy);font-size:11px;margin-bottom:3px}.at-flow-step span{font-size:10px;line-height:1.4;color:var(--slate)}.at-checks{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:7px;margin-top:8px}.at-check{display:flex;align-items:center;gap:7px;border:1px solid var(--border);border-radius:8px;padding:8px 10px;background:#F8FAFC;font-size:11px}.at-check input{width:auto}.at-modal-backdrop{position:fixed;inset:0;background:rgba(7,30,69,.45);display:none;align-items:center;justify-content:center;z-index:1000;padding:16px}.at-modal-backdrop.open{display:flex}.at-modal{width:min(620px,100%);max-height:92vh;overflow:auto;background:white;border-radius:14px;box-shadow:0 24px 70px rgba(0,0,0,.24)}.at-modal-head{display:flex;justify-content:space-between;align-items:center;padding:14px 18px;border-bottom:1px solid var(--border)}.at-modal-body{padding:16px 18px}.at-empty{text-align:center;padding:28px 16px;color:var(--slate-light);font-size:12px}.at-danger-zone{border:1px solid #FECACA;border-radius:10px;padding:12px;background:#FFF7F7}.at-danger-zone strong{color:#991B1B;font-size:12px}.at-danger-zone p{font-size:11px;line-height:1.45;color:#7F1D1D;margin:4px 0 10px}.at-tabs{display:flex;gap:6px;overflow-x:auto;padding:6px;background:#F8FAFC;border:1px solid var(--border);border-radius:12px;scrollbar-width:thin}.at-tab{white-space:nowrap;min-height:38px;border:0;border-radius:8px;background:transparent;color:var(--slate);padding:0 14px;font:inherit;font-size:12px;font-weight:800;cursor:pointer}.at-tab:hover{background:white;color:var(--brand-navy)}.at-tab.active{background:var(--brand-navy);color:white;box-shadow:0 1px 2px rgba(7,30,69,.16)}.at-tab-panel{display:none}.at-tab-panel.active{display:block}.at-summary{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.at-summary-card{border:1px solid var(--border);border-radius:10px;padding:12px;background:white}.at-summary-card span{display:block;color:var(--slate-light);font-size:10px;text-transform:uppercase;font-weight:800;letter-spacing:.04em}.at-summary-card strong{display:block;margin-top:4px;font-size:15px;color:var(--brand-navy)}.at-two-col{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(280px,.8fr);gap:16px}.at-stack{display:flex;flex-direction:column;gap:16px}@media(max-width:1100px){.at-component-grid,.at-builder-grid{grid-template-columns:1fr 1fr 1fr}.at-flow,.at-summary{grid-template-columns:1fr 1fr}.at-two-col{grid-template-columns:1fr}}@media(max-width:980px){.at-filter{grid-template-columns:1fr 1fr}}@media(max-width:640px){.at-filter,.at-component-grid,.at-builder-grid,.at-flow,.at-summary{grid-template-columns:1fr}.at-head .at-btn{width:100%}.at-tab{padding:0 11px}.at-table{min-width:720px}}
</style>
@endpush
...
<div class="at-page">
    <div class="at-head">
        <div>
            ...
            <p>Configure assessment structure without crowding the workspace. Template list, components, assignment, settings and scoring guidance are separated into tabs on this page.</p>
        </div>
    ...
    <div class="at-tabs" role="tablist" aria-label="Assessment template configuration">
        <button class="at-tab active" type="button" data-tab="templates" role="tab">Templates</button>
        <button class="at-tab" type="button" data-tab="components" role="tab" @disabled(!$selectedTemplate)>Components</button>
        <button class="at-tab" type="button" data-tab="assignment" role="tab" @disabled(!$selectedTemplate)>Assignment & Usage</button>
        <button class="at-tab" type="button" data-tab="settings" role="tab" @disabled(!$selectedTemplate)>Settings</button>
        <button class="at-tab" type="button" data-tab="guide" role="tab">Scoring Guide</button>
    </div>

    <section class="at-tab-panel active" data-panel="templates" role="tabpanel">
        <div class="at-stack">
            <div class="at-card">
    ...
    <section class="at-tab-panel" data-panel="components" role="tabpanel">
        @if($selectedTemplate)
            <div class="at-card">
                <div class="at-section-head">
                    <div><strong>{{ $selectedTemplate->name }} — Components</strong><small>Configure CA, tests, practicals and Examination contribution.</small></div>
                    <span class="at-weight">{{ rtrim(rtrim(number_format($selectedTotal,2),'0'),'.') }} / 100%</span>
                </div>
                <div class="at-body">
                    <div class="at-summary" style="margin-bottom:14px">
                        <div class="at-summary-card"><span>Components</span><strong>{{ $selectedTemplate->components->count() }}</strong></div>
                        <div class="at-summary-card"><span>Total Weight</span><strong>{{ rtrim(rtrim(number_format($selectedTotal,2),'0'),'.') }}%</strong></div>
                        <div class="at-summary-card"><span>Status</span><strong>{{ ucfirst($selectedTemplate->status) }}</strong></div>
                        <div class="at-summary-card"><span>Structure</span><strong>{{ $structureLocked ? 'Locked' : 'Editable' }}</strong></div>
                    </div>

                    @if($structureLocked)
                        <div class="at-alert at-alert-warn" style="margin-bottom:12px"><strong>Scoring structure locked.</strong> Student scores have been recorded using this template, so component names, weights and score-source configuration are protected. Duplicate the template for a new scoring structure.</div>
    ...
    <section class="at-tab-panel" data-panel="assignment" role="tabpanel">
        @if($selectedTemplate)
        <div class="at-two-col">
            <div class="at-card">
                <div class="at-section-head"><div><strong>Assignment</strong><small>Apply {{ $selectedTemplate->name }} to class levels for an academic session.</small></div></div>
                <div class="at-body">
                    @if($selectedTemplate->status==='active' && abs($selectedTotal-100)<0.001)
                        <div class="at-alert at-alert-info" style="margin-bottom:12px">The template is ready for assignment. Existing assignments without scores remain synchronized if the structure changes.</div>
                        <button class="at-btn at-btn-primary" type="button" onclick="openModal('assignTemplateModal')">Assign Template</button>
                    @else
            ...
            <div class="at-card">
                <div class="at-section-head"><div><strong>Current Usage</strong><small>Class levels currently linked to this template.</small></div></div>
                <div class="at-body">
                    @forelse($selectedTemplate->assignments->where('is_active',true) as $assignment)
                        <div style="padding:10px 0;border-bottom:1px solid var(--border)"><div class="at-name">{{ $assignment->classLevel?->name ?? 'Class level' }}</div><div class="at-sub">{{ $assignment->session?->name ?? 'Session' }}</div></div>
                    @empty<div class="at-empty" style="padding:14px">Not assigned yet.</div>@endforelse
                </div>
            </div>
        </div>
        @endif
    ...
    <section class="at-tab-panel" data-panel="settings" role="tabpanel">
        @if($selectedTemplate)
        <div class="at-two-col">
            <div class="at-card">
                ...
                <div class="at-body">
                    <form method="POST" action="{{ route('assessment-templates.update',$selectedTemplate) }}">@csrf @method('PUT')
                        ...
                        <div class="at-field" style="margin-top:12px"><label>Description</label><textarea name="description">{{ $selectedTemplate->description }}</textarea></div>
                        <div class="at-field" style="margin-top:12px"><label>Status</label><select name="status"><option value="draft" @selected($selectedTemplate->status==='draft')>Draft</option><option value="active" @selected($selectedTemplate->status==='active')>Active</option></select></div>
                        <button class="at-btn at-btn-primary" type="submit" style="margin-top:14px">Save Template</button>
                    </form>
                </div>
            </div>
            ...
            <div class="at-stack">
                <div class="at-card">
                    <div class="at-section-head"><div><strong>Duplicate Template</strong><small>Create a new Draft from this structure.</small></div></div>
                    <div class="at-body">
                        <p class="at-sub" style="margin:0 0 10px">Use duplication when a scored template is locked or when you need a new variation for another session.</p>
                        <form method="POST" action="{{ route('assessment-templates.duplicate',$selectedTemplate) }}">@csrf<button class="at-btn" type="submit">Duplicate Template</button></form>
                    </div>
                </div>
                    ...
                    <div class="at-body">
                        <div class="at-danger-zone">
                            ...
                            @else
                                ...
                                <p>This template may be deleted even if it has been assigned. EduCore will safely remove its unscored runtime assessment rows.</p>
    ...
    <section class="at-tab-panel" data-panel="guide" role="tabpanel">
        <div class="at-card">
            <div class="at-section-head"><div><strong>How Examination scoring works</strong><small>One Exam component supports CBT and non-CBT schools.</small></div></div>
            <div class="at-body">
...
(function(){
    const tabs = Array.from(document.querySelectorAll('.at-tab[data-tab]'));
    const panels = Array.from(document.querySelectorAll('.at-tab-panel[data-panel]'));
    if(!tabs.length || !panels.length) return;

    const selectedId = @json($selectedTemplate?->id);
    const storageKey = 'educore.assessmentTemplates.tab.' + (selectedId || 'none');

    function activate(name, updateHash=true){
        const target = tabs.find(tab => tab.dataset.tab === name && !tab.disabled);
    ...
    activate(hashTab || savedTab || 'templates', false);
})();
</script>
@endpush