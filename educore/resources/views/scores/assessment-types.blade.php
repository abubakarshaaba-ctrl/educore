...
@push('styles')
<style>
.at-page{display:flex;flex-direction:column;gap:16px;min-width:0}.at-head{display:flex;justify-content:space-between;gap:14px;align-items:flex-start;flex-wrap:wrap}.at-head h2{margin:0;font-size:18px!important;color:var(--midnight)}.at-head p{margin:4px 0 0;color:var(--slate-light);font-size:12px;max-width:820px}.at-tabs{display:flex;gap:4px;padding:4px;background:#fff;border:1px solid var(--border);border-radius:10px;overflow-x:auto;-webkit-overflow-scrolling:touch;scrollbar-width:none;max-width:100%}.at-tabs::-webkit-scrollbar{display:none}.at-tab{border:0;background:transparent;color:var(--slate);font:inherit;font-size:12px;font-weight:800;padding:9px 14px;border-radius:7px;cursor:pointer;white-space:nowrap;flex:0 0 auto}.at-tab.active{background:var(--brand-gold);color:var(--brand-navy)}.at-panel{display:none;min-width:0}.at-panel.active{display:block}.at-btn{min-height:40px;display:inline-flex;align-items:center;justify-content:center;gap:6px;border:1px solid var(--border);border-radius:8px;padding:0 14px;background:#fff;color:var(--midnight);font:inherit;font-size:12px;font-weight:800;text-decoration:none;cursor:pointer}.at-btn-primary{background:var(--brand-gold);border-color:var(--brand-gold);color:var(--brand-navy)}.at-btn-danger{background:#FEF2F2;border-color:#FECACA;color:#991B1B}.at-btn:disabled{opacity:.45;cursor:not-allowed}.at-card{background:#fff;border:1px solid var(--border);border-radius:12px;overflow:hidden;min-width:0}.at-section-head{background:var(--brand-navy);color:#fff;padding:12px 16px;border-bottom:2px solid var(--brand-gold);display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap}.at-section-head strong{font-size:13px}.at-section-head small{display:block;color:#CBD5E1;font-size:11px;margin-top:2px}.at-body{padding:16px;min-width:0}.at-field{min-width:0}.at-field label{display:block;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.04em;color:var(--slate-light);margin-bottom:5px}.at-field input,.at-field select,.at-field textarea{width:100%;min-width:0;box-sizing:border-box;border:1px solid var(--border);border-radius:8px;background:#F8FAFC;font:inherit;font-size:12px}.at-field input,.at-field select{height:40px;padding:0 10px}.at-field textarea{min-height:72px;padding:9px 10px}.at-filter{display:grid;grid-template-columns:2fr 1fr 1fr auto;gap:10px;align-items:end}.at-table-wrap{width:100%;max-width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch}.at-table{width:100%;border-collapse:collapse;min-width:820px}.at-table th{height:38px;background:#F8FAFC;color:var(--slate-light);font-size:10px;text-transform:uppercase;letter-spacing:.04em;padding:8px 12px;text-align:left;border-bottom:1px solid var(--border)}.at-table td{height:44px;padding:9px 12px;border-bottom:1px solid var(--border);font-size:12px;vertical-align:middle}.at-table tr.selected{background:var(--brand-gold-light)}.at-name{font-weight:800;color:var(--midnight);overflow-wrap:anywhere}.at-sub{font-size:11px;color:var(--slate-light);margin-top:2px;line-height:1.45;overflow-wrap:anywhere}.at-badge{display:inline-flex;align-items:center;border-radius:999px;padding:3px 8px;font-size:10px;font-weight:900}.at-active{background:#ECFDF5;color:#047857}.at-draft{background:#F1F5F9;color:#64748B}.at-locked{background:#FEF2F2;color:#991B1B}.at-editable{background:#EFF6FF;color:#1D4ED8}.at-weight{display:inline-flex;border-radius:999px;background:var(--brand-gold-light);color:var(--brand-gold-dark);padding:5px 9px;font-size:11px;font-weight:900}.at-alert{border-radius:9px;padding:10px 13px;font-size:12px;line-height:1.5;overflow-wrap:anywhere}.at-alert-success{background:#ECFDF5;border:1px solid #A7F3D0;color:#065F46}.at-alert-error{background:#FEF2F2;border:1px solid #FECACA;color:#991B1B}.at-alert-warn{background:#FFFBEB;border:1px solid #FDE68A;color:#92400E}.at-alert-info{background:#EFF6FF;border:1px solid #BFDBFE;color:#1E3A8A}.at-component{border:1px solid var(--border);border-radius:10px;padding:12px;margin-bottom:10px;min-width:0}.at-component.exam{border-left:3px solid var(--brand-gold)}.at-component-top{display:flex;justify-content:space-between;gap:10px;align-items:center;min-width:0}.at-component-grid{display:grid;grid-template-columns:1.6fr .7fr 1fr auto;gap:8px;align-items:end;margin-top:10px}.at-builder{border:1px dashed #CBD5E1;border-radius:10px;padding:14px;margin-top:14px;background:#FCFDFE;min-width:0}.at-builder-grid{display:grid;grid-template-columns:1.6fr .7fr 1fr;gap:8px}.at-total{display:flex;justify-content:space-between;align-items:center;padding-top:12px;margin-top:12px;border-top:1px solid var(--border);font-weight:900}.at-layout{display:grid;grid-template-columns:minmax(0,1.4fr) minmax(300px,.8fr);gap:16px}.at-layout>*{min-width:0}.at-checks{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:7px;margin-top:8px}.at-check{display:flex;align-items:center;gap:7px;border:1px solid var(--border);border-radius:8px;padding:8px 10px;background:#F8FAFC;font-size:11px;min-width:0}.at-check span{overflow-wrap:anywhere}.at-check input{width:auto}.at-danger-zone{border:1px solid #FECACA;border-radius:10px;padding:12px;background:#FFF7F7}.at-flow{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}.at-flow-step{border:1px solid #D7E1EF;border-radius:9px;padding:10px;background:#fff;min-width:0}.at-flow-step strong{display:block;color:var(--brand-navy);font-size:11px;margin-bottom:3px}.at-flow-step span{font-size:10px;line-height:1.4;color:var(--slate)}.at-modal-backdrop{position:fixed;inset:0;background:rgba(7,30,69,.45);display:none;align-items:center;justify-content:center;z-index:1000;padding:16px}.at-modal-backdrop.open{display:flex}.at-modal{width:min(620px,100%);max-height:92vh;overflow:auto;background:#fff;border-radius:14px;box-shadow:0 24px 70px rgba(0,0,0,.24)}.at-modal-head{display:flex;justify-content:space-between;align-items:center;padding:14px 18px;border-bottom:1px solid var(--border)}.at-modal-body{padding:16px 18px}.at-empty{text-align:center;padding:28px 16px;color:var(--slate-light);font-size:12px}
@media(max-width:900px){.at-layout{grid-template-columns:1fr}.at-filter,.at-component-grid,.at-builder-grid{grid-template-columns:1fr 1fr}.at-flow{grid-template-columns:1fr 1fr}}
@media(max-width:640px){.at-page{gap:12px}.at-head{gap:10px}.at-head>div{min-width:0}.at-head h2{font-size:17px!important}.at-head p{font-size:11px}.at-filter,.at-component-grid,.at-builder-grid,.at-flow{grid-template-columns:1fr}.at-head .at-btn{width:100%}.at-body{padding:12px}.at-section-head{padding:10px 12px;align-items:flex-start}.at-component{padding:10px}.at-component-top{align-items:flex-start}.at-component-top>div{min-width:0}.at-component-grid .at-btn{width:100%}.at-builder{padding:11px}.at-table{min-width:760px}.at-table th,.at-table td{padding:8px 9px}.at-checks{grid-template-columns:1fr 1fr}.at-modal-backdrop{padding:8px;align-items:flex-end}.at-modal{width:100%;max-height:94vh;border-radius:14px 14px 0 0}.at-modal-head{padding:12px 14px}.at-modal-body{padding:14px}.at-modal-body>div:last-child{display:grid!important;grid-template-columns:1fr 1fr}.at-modal-body>div:last-child .at-btn{width:100%}}
@media(max-width:380px){.at-checks{grid-template-columns:1fr}.at-modal-body>div:last-child{grid-template-columns:1fr}}
</style>
@endpush
