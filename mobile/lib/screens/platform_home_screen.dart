    ...
    builder: (data) {
      ...
      return RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            _PlatformHero(name: operator['name']?.toString() ?? 'Super Admin'),
    ...
    children: [
      SizedBox(
        ...
        child: ListView(
          ...
          children:
              ['all', 'active', 'pending', 'suspended', 'subscription_expired']
                  .map(
                    (value) => Padding(
...
class _BillingScreenState extends State<_BillingScreen> {
  ...
  Widget build(BuildContext context) => _PlatformFuture(
    future: _future,
    retry: () =>
        setState(() => _future = ApiClient.instance.get('/platform/billing')),
    builder: (data) {
