  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: IndexedStack(
          ...
          children: [
            ...
            const _PlansScreen(),
            _GovernanceScreen(onNavigate: (tab) => setState(() => _tab = tab)),
          ],
        ),
...
class _SchoolsScreenState extends State<_SchoolsScreen> {
  ...
  Future<Map<String, dynamic>> _load() => ApiClient.instance.get(
        '/platform/tenants',
        _filter == 'all' ? null : {'status': _filter},
      );
              ...
              builder: (data) {
                ...
                return RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (_, index) => _SchoolTile(
                      item: _asMap(schools[index]),
  ...
  Future<void> _registerSchool() async {
        ...
        builder: (ctx) => AlertDialog(
                ...
                content: SingleChildScrollView(
                  ...
                  TextField(
                      controller: slug,
                      decoration:
                          const InputDecoration(labelText: 'School slug')),
                  const SizedBox(height: 9),
                  TextField(
                      controller: email,
                  ...
                  TextField(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'School phone')),
                  const SizedBox(height: 9),
                  TextField(
                ...
                actions: [
                  ...
                  FilledButton(
                      onPressed: () => Navigator.pop(ctx, {
                            ...
                            'admin_name': adminName.text.trim(),
    ...
    try {
      final response =
          await ApiClient.instance.post('/platform/tenants', result);
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content:
                Text(response['message']?.toString() ?? 'School registered.'),
            ...
            child: ListView(
              ...
              children: [
                ...
                ...plans.map((raw) {
                  ...
                  final features =
                      plan['features'] as List<dynamic>? ?? const [];
                  return Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Complete platform access with RBAC for every supported school role.',
...
class _GovernanceScreen extends StatelessWidget {
  const _GovernanceScreen({required this.onNavigate});
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        Text(
          user['name']?.toString() ?? 'Platform Super Admin',
        ...
        const Text(
          'EduCore Platform · Global privileged access',
          textAlign: TextAlign.center,
        ...
        _PlatformTile(
          ...
          subtitle: 'Activate, suspend, or adjust school capacity.',
          ...
          children: [
            ...
            const Row(
              children: [
                ...
                SizedBox(width: 6),
                Text(
                  'Global privileged access · Platform scope',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 12,
                    fontWeight: FontWeight.w700,
...
class _SchoolTile extends StatelessWidget {
  const _SchoolTile({required this.item, this.onChanged});
  ...
  Widget build(BuildContext context) => _PlatformTile(
        ...
        onTap: onChanged == null ? null : () => _manage(context),
      );
  ...
  Future<void> _manage(BuildContext context) async {
              ...
              onPressed: () async {
                try {
                  await ApiClient.instance.patch(
                    '/platform/tenants/${item['id']}',
                    {'students_capacity': int.parse(capacity.text)},
                  );
              ...
              children: [
                ...
                Expanded(
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(foregroundColor: kRisk),
    ...
    if (status != 'updated') {
      try {
        await ApiClient.instance.patch('/platform/tenants/${item['id']}', {
          'status': status,
        });
      } catch (e) {
        if (context.mounted)
