...
class _ParentDashboard extends StatefulWidget {
  const _ParentDashboard(
      {super.key, required this.childId, required this.onChildSelected});
  final int? childId;
                              ...
                              child: Row(children: [
                                ...
                                Expanded(
                                    child: Column(
                                        ...
                                        children: [
                                      Text(child['name']?.toString() ?? 'Child',
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: const TextStyle(
                                              color: kInk,
...
class _ParentNotices extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _ParentFuture(
      future: ApiClient.instance.get('/parent/dashboard',
...
class _ParentMore extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(padding: const EdgeInsets.all(16), children: [
      ...
      const SizedBox(height: 12),
      Text(user['name']?.toString() ?? 'Parent / Guardian',
          textAlign: TextAlign.center,
          style: const TextStyle(
...
class _ParentHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const Text('Your children’s school life, clearly connected.',
              style: TextStyle(color: Color(0xFFCFDCF0))),
          const SizedBox(height: 14),
          const Row(mainAxisSize: MainAxisSize.min, children: [
            Icon(Icons.lock_outline, color: kGold, size: 16),
            SizedBox(width: 6),
            Text('Parent access · Linked children only',
                style: TextStyle(
                    color: Colors.white,
                    fontSize: 12,
