...
val approvedFirebaseConfig = file("firebase/google-services.json").takeIf { it.exists() }
    ?: rootProject.file("../mobile/android/app/google-services.json").takeIf { it.exists() }

if (approvedFirebaseConfig != null) {
