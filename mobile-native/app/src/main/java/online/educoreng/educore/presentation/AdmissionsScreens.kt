...
private fun AdmissionStat(label: String, value: Int) {
    Card(Modifier.widthIn(min = 112.dp, max = 168.dp), colors = CardDefaults.cardColors(containerColor = EduCoreColors.White), border = BorderStroke(1.dp, EduCoreColors.Line200)) {
